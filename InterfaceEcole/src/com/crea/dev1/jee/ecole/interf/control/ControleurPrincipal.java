...
public class ControleurPrincipal extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		case ("index"):
			...
			break;
		case ("show"):
			String num = actionValue;
			Eleve etemp = EleveDAO.getEleveByNum(num);
		...
		case ("edit"):
			num = actionValue;
			etemp = EleveDAO.getEleveByNum(num);
	...
	/**
	 * Méthode permettant de récupérer l'action et la valeur associé à cette action
	 * de l'url.
	 * 
	...
	protected String[] getActionRequest(HttpServletRequest request) {
		...
		// request.getRequestURI() retournera l'url complete
		// p.ex(localhost:8080/InterfaceEasyJEE/user/add)
		// request.getContextPath() retournera l'url du point d'entrée (p.ex:
		// localhost:8080/InterfaceEasyJEE/)
